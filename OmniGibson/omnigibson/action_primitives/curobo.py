...
def holonomic_base_command_in_world_frame(robot, joint_pos):
    ...
    if not robot.is_holonomic_base:
        raise ValueError("holonomic_base_command_in_world_frame only supports holonomic-base robots.")
...
def holonomic_base_pose_in_root_frame(robot):
    ...
    """
    if not robot.is_holonomic_base:
        raise ValueError("holonomic_base_pose_in_root_frame only supports holonomic-base robots.")
